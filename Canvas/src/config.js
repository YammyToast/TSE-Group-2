...
function getSVG(_key, _colorScheme) {
    switch (_key) {
        case "rainfall":
            return `<svg viewBox="0 0 28 25" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        case "lowTemp":
            return `<svg viewBox="0 0 25 26" fill="none" xmlns="http://www.w3.org/2000/svg">
